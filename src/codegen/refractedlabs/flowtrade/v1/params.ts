...
export const GasParameters = {
  ...
  toAmino(message: GasParameters, useInterfaces: boolean = true): GasParametersAmino {
    const obj: any = {};
    obj.flow_create = message.flowCreate !== BigInt(0) ? message.flowCreate.toString() : undefined;
    obj.flow_stop = message.flowStop !== BigInt(0) ? message.flowStop.toString() : undefined;
    return obj;
  },
